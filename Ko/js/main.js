    ...
    $('#fullpage').fullpage({
        ...
        afterLoad: function(anchorLink, index){
            ...
            if (index == 1) {// 01 = true
                ...
                $('#section01 .fp-tableCell .title > h3').removeClass('on');
                $('#section01 .fp-tableCell .title > h2').removeClass('on');
                $('#section01 .fp-tableCell .title > p').removeClass('on');
                $('#section01 .fp-tableCell .sc01').removeClass('on');
            }
            if(index ==2){// 02 = true
